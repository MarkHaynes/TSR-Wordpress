<?php
	...
	**/
	...
	// Session start - Moved this to top of header.php in theme
	...
	function display_latest_tweets(
		...
		$date_format         = 'g:i A jS M',    // Date formatting. (http://php.net/manual/en/function.date.php)
		...
		$consumerkey         = "u4J2abumNYtMFOI96KOSIrd8a";
		$consumersecret      = "9madpmbsiOwF2GgohShJzXzmO3yg5txKYCsnBKrMHxh0JmtWqG";
		$accesstoken         = "38329507-NorwoNVZRzJpWLOy7BeKiii5o4Urz37lkpVYNeLpE";
		$accesstokensecret   = "5OVLo54UgnGnlGTZxqBSJ9puL1DvZBRI6gyzKlFPDaVjz";
	...
	display_latest_tweets('TSRHeritage');
?>
